...
class WorkoutSetUp extends StatefulWidget {
  ...
  @override
  State<WorkoutSetUp> createState() => _WorkoutTrackTypeState();
}

bool isManualSelected = false;
bool isAutomaticSelected = false;

class _WorkoutTrackTypeState extends State<WorkoutSetUp> {
  String logStr = '';
          ...
          onPressed: () async {
            ...
            if (hello == false) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ManualAccountSetup1(
                    email: widget.email,
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AutomaticAccountSetup1(
                    email: widget.email,
                    username: widget.username,
                    uid: widget.uid,
                    photoURL: widget.photoURL,
